...
/** "Añadir ingreso": propina, cobro de una deuda pendiente u otro ingreso manual, con su
 * método de pago. Compartido entre el Dashboard ("Ventas de hoy") y Administración → Resumen,
 * para que todo ingreso manual quede siempre registrado igual, sin importar desde dónde se cargue. */
