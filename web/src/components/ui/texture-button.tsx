  ...
  'w-full h-full flex items-center justify-center text-muted-foreground',
  {
    variants: {
      variant: {
        ...
        brand:
          'gap-2 bg-gradient-to-b from-brand-500 to-brand-800 text-sm text-[color:var(--qt-button-text,rgba(255,255,255,0.9))] transition duration-300 ease-in-out hover:from-brand-400 hover:to-brand-500 active:from-brand-800 active:to-brand-900',
        destructive:
