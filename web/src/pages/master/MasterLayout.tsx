...
import { BarChart3, DollarSign, LogOut, MessageCircle, Nfc, Receipt, ShieldCheck, Store, Tag, Users, Wallet } from 'lucide-react';
...
const NAV_LINKS = [
  ...
  { to: '/master/whatsapp', label: 'WhatsApp', icon: MessageCircle },
