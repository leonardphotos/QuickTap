...
export default function WalletInfoPage() {
  ...
  return (
    <div className="relative min-h-dvh overflow-hidden bg-[#04070d] text-white">
      ...
      <div className="relative mx-auto w-full max-w-md px-6 pb-16 pt-9 sm:max-w-lg">
        {/* ---------- Marca ---------- */}
        ...
        {/* ---------- Qué es ---------- */}
        <h1 className="mt-12 text-[34px] font-bold leading-[1.12] tracking-tight">
          Tus compras,
          <br />
          <span className="text-[#3d9bff]">en tu bolsillo.</span>
        </h1>
        <p className="mt-4 max-w-[24rem] text-[14px] font-light leading-relaxed text-white/55">
        ...
        {/* ---------- Funciones ---------- */}
        <ul className="mt-14 space-y-2.5">
          {FUNCIONES.map((f, i) => (
            <li
              key={f.titulo}
              className="wallet-fila flex gap-3.5 rounded-2xl bg-white/[0.045] p-4 ring-1 ring-white/[0.06]"
            ...
            >
              ...
              <span className="min-w-0">
                <span className="block text-[14.5px] font-semibold">{f.titulo}</span>
                <span className="mt-0.5 block text-[12.5px] font-light leading-relaxed text-white/50">{f.texto}</span>
              </span>
            </li>
          ))}
        </ul>
        ...
        {/* ---------- Cómo se entra ---------- */}
        <h2 className="mt-14 text-[20px] font-bold">Entrar toma un minuto</h2>
        ...
        {/* ---------- Cierre: la descarga ---------- */}
        <div className="mt-14 rounded-3xl bg-white/[0.045] p-6 text-center ring-1 ring-white/[0.06]">
          ...
          <a
            href={APK_URL}
            className="wallet-tap mt-5 inline-flex w-full items-center justify-center gap-2 rounded-full py-2.5 text-[13.5px] font-semibold text-white shadow-[0_8px_24px_-10px_rgba(0,154,255,0.8)]"
            style={{ background: 'linear-gradient(135deg, #009aff 0%, #056CF2 100%)' }}
          >
