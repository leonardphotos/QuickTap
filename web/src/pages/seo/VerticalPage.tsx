    ...
    <SeoPageLayout>
      ...
      <section className="mt-10 grid sm:grid-cols-3 gap-5">
        {page.points.map((pt) => (
          ...
          >
            <h2 className="text-sm font-semibold mb-1.5 group-hover:text-brand-logo transition-colors">{pt.title}</h2>
            <p className="text-[13px] text-brand-950/60 font-light leading-relaxed">{pt.text}</p>
