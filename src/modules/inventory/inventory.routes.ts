...
// Copiar los ingredientes de un tamaño a otro del mismo plato.
router.post('/recipes/:productId/duplicate-variant', requireFeature('inventoryRecipe'), mutate, recipeController.duplicateVariant);
